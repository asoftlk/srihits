...
//   echo $command = "/usr/bin/ffmpeg -y -i $inputpath -i $imgpath -filter_complex 'overlay = main_w-(overlay_w+10):10' $logoOutput";
    ...
    echo "Output: " . print_r($output1, true); // Print output
    echo "Return Value: " . $retval; // Print return value
     if($retval!='' && $retval==0){
        //  unlink($inputpath);
