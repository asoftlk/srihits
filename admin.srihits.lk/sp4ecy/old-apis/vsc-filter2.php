...
$condT = $type == '' ? "" : " AND type='$type' ";
$query = "select SQL_CALC_FOUND_ROWS  * from vsc where userid = '$userid' ".$condt." ".$condL." ".$condG." ".$condD." ".$condC." ".$condDt." ".$condT."  order by id DESC limit $cal, $limit";
