...
$query = "insert into tvseriesdetails (userid,videoid,title,slug,series,shortdescription,description,castcrew,episode,season,languages,imdbrating,releasedate,countries,genre,runtime,kids,email,push,publish,insertdatetime,approve,price,trailerid,directors,writers) values
