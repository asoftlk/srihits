...
if($row>0){
    ...
    countries='$country',genre='$genre',runtime='$runtime',kids='$kid',sendemail='$subs',pushnotification='$notif',publish='$publish',insertdatetime='$datetime',approve='$approve',price='$price',usd_price='$usd_price',trailerid='$trailerid' where videoid='$unqid'";
    $chk = mysqli_query($con,$query);
...
$query = "insert into moviedetails (userid,videoid,title,slug,shortdescription,description,castcrew,directors,writers,languages,imdbrating,releasedate,countries,genre,runtime,kids,sendemail,pushnotification,publish,insertdatetime,approve,price,usd_price,trailerid) values
('$userid','$unqid','$title','$slug','$shortdescrip','$desc','$cacr','$director','$writer','$languages','$rating','$releDat','$country','$genre','$runtime','$kid','$subs','$notif','$publish','$datetime','$approve','$price','$usd_price','$trailerid')";
$chk = mysqli_query($con,$query);
