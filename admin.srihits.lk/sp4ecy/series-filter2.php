...
$condT = $type == '' ? "" : " AND series='$type' ";
$query = "select SQL_CALC_FOUND_ROWS  * from tvseriesdetails where userid = '$userid' ".$cond." ".$condL." ".$condG." ".$condD." ".$condC." ".$condDt." ".$condT." order by id DESC limit $cal, $limit";
