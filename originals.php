    ...
    <?php
        ...
        <div class="position-absolute moviecontent">
            ...
            <div class="text-light position-absolute pb-5 bottom-0 d-flex movieplay">';
                ...
                echo '<div class="text-light text-center ms-5 moviewish" style="margin-top:-10px">';
                if(isset($_SESSION['userid'])){
                ...
                <div class="text-light text-center ms-5 movieshare position-relative">
                    ...
                    <div class="sharelink position-absolute p-1" style="background-color:#192133; border-radius:10px; right:0">
                        <a onclick="MyWindow=window.open(\'https://www.facebook.com/sharer/sharer.php?u=https://srihits.veramasait.com/demo/originals?id='.$id.'\',\'MyWindow\',\'width=600,height=400\'); return false;"><i class="bi bi-facebook px-3 fs-4 rounded"></i></a>
                        <a onclick="MyWindow=window.open(\'https://api.whatsapp.com/send?text=https://srihits.veramasait.com/demo/originals?id='.$id.'\',\'MyWindow\',\'width=600,height=400\'); return false;"><i class="bi bi-whatsapp px-3 fs-4 rounded"></i></a>
                        <a onclick="MyWindow=window.open(\'https://telegram.me/share/url?url=https://srihits.veramasait.com/demo/originals?id='.$id.'\',\'MyWindow\',\'width=600,height=400\'); return false;"><i class="bi bi-telegram px-3 fs-4 rounded"></i></a>
                        <a onclick="MyWindow=window.open(\'https://twitter.com/intent/tweet?url=https://srihits.veramasait.com/demo/originals?id='.$id.'\',\'MyWindow\',\'width=600,height=400\'); return false;"><i class="bi bi-twitter ps-3 pe-3 fs-4 rounded"></i></a>
                        <i class="bi bi-link-45deg px-3 fs-4 rounded"  value="https://srihits.veramasait.com/demo/originals?id='.$id.'"></i>
                    </div>
                </div> 
            </div>
        </div>';
...
echo '<br style="clear:both"><div  class="container-fluid ps-3">';
            ...
            echo '<h5 class="text-light  ms-3 mt-5">Related Originals</h5>
...
<script>
    ...
    $('#srihitsDropdown').css({'color':'#ffaa05', 'font-weight':'bold'});
